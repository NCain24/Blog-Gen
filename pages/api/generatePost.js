...
export default withApiAuthRequired(async function handler(req, res) {
  ...
  const postContentResponse = await openai.createChatCompletion({
    ...
    messages: [
      ...
      {
        role: 'user',
        content: `Write a long and detailed SEO-friendly blog post about ${topic} that target the following comma-separated ${keywords},
  ...
  const metaDescriptionResponse = await openai.createChatCompletion({
    ...
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Generate SEO-friendly meta description content for the above post',
      },
    ],
  });
